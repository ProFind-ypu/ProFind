...
import type { Item } from "../../testing/constants";

type Props = { project_info: Item }; 
   ...
   return (
      <div
         ...
         <div>
            ...
            <p className="pl-1 pb-1 text-xs">Created at: { project_info.creation_time.toLocaleDateString("en-GB")  } </p>
